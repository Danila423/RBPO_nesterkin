...
| Логи/аудит          | ≥95% критичных действий (создание/удаление Wish, смена пароля) порождают событие audit{actor, action, resource, result, correlation_id} в течение ≤ 5 сек.           |
| Приватность/ретеншн | Храним только минимально-необходимые поля (title, link, price_estimate, notes); в API/логах маскирование ПДн; данные удаляются >30 дней, если нет иных обязанностей. |
